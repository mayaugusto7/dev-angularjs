        ...
        return {
            ...
            link: function ($scope, $element, $attrs) {
                ...
                $scope.onSelect = function () {
                    ...
                    // Paramettros que podem ser passados para a funcao whenSelect
                    /**
                     *
                     ...
                     *
                     *  Os nomes passados como parametros devem ser passados igual o que esta acima
                     *
                     * <div stock-widget
                     * stock-data="stock"
                     * stock-title="Stock {{$index}}. {{stock.name}}"
                     * when-select="mainCtrl.onStockSelect(stockPrice, stockName, stockPrevious)"
                        ></div>

                     A diretiva controla quando a funcao abaixo deve ser chamada
